                ...
                <td>
                    <form method="post">
                        <div style="font-size: 24px">
                            ...
                            <input type="text" placeholder="商品名を入力して下さい" name="item_name" maxlength="255" style="font-size: 18px; width: 500px" value="<?php if (empty($_POST['item'])) {
                                                                                                                                                            print(htmlspecialchars($item['item_name'], ENT_QUOTES));
                                                                                                                                                        } else {
                                                                                                                                                            print(htmlspecialchars($_POST['item']['item_name'], ENT_QUOTES));
                                                                                                                                                        }
                                                                                                                                                        ?>">
